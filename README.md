...
- **Free Merchants:** Forces every shop menu entry to show a cost of zero, allowing you to buy gear, consumables, and upgrades without spending any gold while the toggle is enabled. Covers the standard shop UI (Nestor, Trickster, etc.), Eugene's custom event-driven shop, and Mutt's special-inventory shop, where picking "Buy." / "Buy it." no longer deducts gold.
